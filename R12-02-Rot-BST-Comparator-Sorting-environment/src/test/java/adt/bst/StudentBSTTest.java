...
public class StudentBSTTest {
	...
	private SortComparatorBSTImpl<Integer> tree = new SortComparatorBSTImpl<>();
	...
	public void testReverseOrder() {
		...
		Integer[] lista = new Integer[] { 232, 76, 67, 23, 12, 9, 6, 5, 2, 0, -34, -40 };
		assertEquals(lista, tree.reverseOrder());
	...
	public void testSort() {
		...
		assertEquals(order, tree.sort(new Integer[] { 232, 76, 67, 23, 12, 9, 6, 5, 2, 0, -34, -40 }));
